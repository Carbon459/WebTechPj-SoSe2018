...
C.Z=I.ao(["x","house_red","house_green","house_blue","player","enemyBasic","road_basic","road_end","road_intersection","road_L","road_T","grass","1up","block"])
C.p=new H.d3(14,{x:"removeForeground",house_red:"Scenery",house_green:"Scenery",house_blue:"Scenery",player:"Player",enemyBasic:"BasicTank",road_basic:"Background",road_end:"Background",road_intersection:"Background",road_L:"Background",road_T:"Background",grass:"Background","1up":"PowerupHeal",block:"Scenery"},C.Z,[null,null])
C.a0=H.w(I.ao([]),[P.bl])
